...
export default function QuoteApproval() {
  ...
  const [customQuote] = useState<CustomQuoteOrder>({
    quoteId: quoteId || "456",
    quoteNumber: "QT-001234",
    customerEmail: "customer@example.com",
    requestDate: "2024-01-20",
    item: {
      id: "quote-1",
      name: "Vintage Silk Evening Gown",
      description:
        "Vintage silk evening gown with intricate beadwork and delicate fabric",
      originalDescription:
        "My grandmother's vintage dress from the 1950s. Has some stains on the front and needs gentle cleaning.",
      price: 89.99,
      service: "Specialty Dry Cleaning",
      imageUrl:
        "https://images.unsplash.com/photo-1566479179817-0e4bc46c8e21?w=400&h=600&fit=crop",
      facilityNotes:
        "This is a delicate vintage piece requiring hand-cleaning with specialized solvents. The beadwork is fragile and will need extra care. We recommend museum-quality preservation techniques.",
      estimatedDays: 5,
      urgency: "standard",
    },
  ...
  const handleDecision = async (newDecision: "approved" | "declined") => {
    ...
    console.log("Submitting decision:", newDecision, declineReason);

    setIsProcessing(false);

    if (newDecision === "approved") {
      // Navigate to order flow with the approved item
      ...
      // Navigate back to orders with decline confirmation
      navigate("/orders", {
        state: {
