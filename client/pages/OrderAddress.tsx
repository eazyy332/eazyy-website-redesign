...
export default function OrderAddress() {
  ...
  const { selectedServices, totalPrice, schedule } = location.state || {
    selectedServices: [],
    totalPrice: 0,
    schedule: {}
  };
  ...
  const savedAddresses: SavedAddress[] = [
    {
      id: '1',
      name: 'Home',
      fullAddress: '123 Main Street, Apt 4B, Amsterdam, 1012 AB, Netherlands',
      isDefault: true
    },
    {
      id: '2',
      name: 'Office',
      fullAddress: '456 Business Ave, Floor 3, Amsterdam, 1013 CD, Netherlands',
      isDefault: false
    }
  ];
