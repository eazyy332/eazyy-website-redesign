      ...
      <main className="px-4 lg:px-16 py-12 lg:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {/* eazzy Bag */}
            <div className="bg-white rounded-3xl p-6 shadow-lg border-2 border-gray-100 hover:border-primary transition-colors group">
              <div className="text-center">
                <div className="w-16 h-16 bg-gray-100 rounded-2xl mx-auto mb-4 flex items-center justify-center group-hover:scale-105 transition-transform">
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/8053aaf5482c5a1eaffc8f5b8f8d52642ee84791?width=160" alt="eazzy Bag" className="w-10 h-10 object-contain" />
                </div>
                <div className="flex items-center justify-center mb-3">
                  ...
                  />
                  <h3 className="text-xl font-medium text-black">Bag</h3>
                </div>
                <p className="text-gray-600 mb-6 text-sm leading-relaxed">
                  Fill our sturdy bag with laundry. Different bag sizes available for different needs.
                </p>
                <Link to="/order/items/eazzy-bag" className="block w-full bg-primary text-white py-3 rounded-full font-medium hover:bg-blue-700 transition-colors">
                  Select Items
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 shadow-lg border-2 border-gray-100 hover:border-primary transition-colors group">
              <div className="text-center">
                <div className="w-16 h-16 bg-gray-100 rounded-2xl mx-auto mb-4 flex items-center justify-center group-hover:scale-105 transition-transform">
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/323ee1d10112f83f8a173fa73990b7e744464d8d?width=160" alt="Wash and Iron" className="w-10 h-10 object-contain" />
                </div>
                <h3 className="text-xl font-medium text-black mb-3">Wash & Iron</h3>
                <p className="text-gray-600 mb-6 text-sm leading-relaxed">
                  Individual items washed and professionally ironed. Choose specific garments.
                </p>
                <Link to="/order/items/wash-iron" className="block w-full bg-primary text-white py-3 rounded-full font-medium hover:bg-blue-700 transition-colors">
                  Select Items
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 shadow-lg border-2 border-gray-100 hover:border-primary transition-colors group">
              <div className="text-center">
                <div className="w-16 h-16 bg-gray-100 rounded-2xl mx-auto mb-4 flex items-center justify-center group-hover:scale-105 transition-transform">
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/fce4d46b116b276f657742c2e7a9594f49ddecfa?width=160" alt="Dry Clean" className="w-10 h-10 object-contain" />
                </div>
                <h3 className="text-xl font-medium text-black mb-3">Dry Cleaning</h3>
                <p className="text-gray-600 mb-6 text-sm leading-relaxed">
                  Professional dry cleaning for delicate items. Various garment types available.
                </p>
                <Link to="/order/items/dry-cleaning" className="block w-full bg-primary text-white py-3 rounded-full font-medium hover:bg-blue-700 transition-colors">
                  Select Items
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 shadow-lg border-2 border-gray-100 hover:border-primary transition-colors group">
              <div className="text-center">
                <div className="w-16 h-16 bg-gray-100 rounded-2xl mx-auto mb-4 flex items-center justify-center group-hover:scale-105 transition-transform">
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/054342f0a30f3564e498e0898a4167eaae155932?width=160" alt="Repair" className="w-10 h-10 object-contain" />
                </div>
                <h3 className="text-xl font-medium text-black mb-3">Repairs</h3>
                <p className="text-gray-600 mb-6 text-sm leading-relaxed">
                  Tailoring and repair services. Different types of alterations and fixes.
                </p>
                <Link to="/order/items/repairs" className="block w-full bg-primary text-white py-3 rounded-full font-medium hover:bg-blue-700 transition-colors">
                  Select Items
                </Link>
              </div>
            </div>
